...
<html>
	...
	<body>
		<a href="#list-positionstyp" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-positionstyp" class="content scaffold-list" role="main">
