...
<html>
	...
	<body>
		<a href="#list-zahlungsteil" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-zahlungsteil" class="content scaffold-list" role="main">
