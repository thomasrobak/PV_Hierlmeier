...
<html>
	...
	<body>
		<a href="#show-medikament" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-medikament" class="content scaffold-show" role="main">
