...
<html>
    <head>
        ...
        <title><g:message code="rechnung.show" default="Show Rechnung" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="rechnung.show" default="Show Rechnung" /></h1>
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name"><g:message code="rechnung.id" default="Id" />:</td>
                                
                                <td valign="top" class="value">${fieldValue(bean: rechnungInstance, field: "id")}</td>
